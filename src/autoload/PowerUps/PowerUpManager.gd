...
var _unlockGraph: Dictionary[PowerUpId, Array] = {
	...
	PowerUpId.WinGame: [PowerUpId.UpgradesUnlock3, PowerUpId.MoreMoon4, PowerUpId.MoreSun4],
	...
	PowerUpId.MaxHealth10: [PowerUpId.MaxHealth9, PowerUpId.UpgradesUnlock3],
	...
	PowerUpId.MoreSun4: [PowerUpId.MoreSun3, PowerUpId.UpgradesUnlock3],
	...
	PowerUpId.MoreMoon4: [PowerUpId.MoreMoon3, PowerUpId.UpgradesUnlock3],
	PowerUpId.CurrencyFrequency: [PowerUpId.UpgradesUnlock2, PowerUpId.MoreSun1],
	PowerUpId.CurrencyFrequency2: [PowerUpId.CurrencyFrequency],
	PowerUpId.MoreCurrency: [PowerUpId.UpgradesUnlock2, PowerUpId.MoreMoon1],
	PowerUpId.MoreCurrency2: [PowerUpId.MoreCurrency],
	PowerUpId.SunLoseFactor: [PowerUpId.MaxHealth3],
	PowerUpId.SunLoseFactor2: [PowerUpId.SunLoseFactor, PowerUpId.UpgradesUnlock2],
	PowerUpId.MoonLoseFactor: [PowerUpId.MaxHealth3],
	PowerUpId.MoonLoseFactor2: [PowerUpId.SunLoseFactor, PowerUpId.UpgradesUnlock2],
}
